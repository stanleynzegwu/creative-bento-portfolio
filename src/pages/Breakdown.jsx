...
//               <div className={`flex flex-col lg:flex-row lg:items-center gap-8 order-1`}>
//                 <p className="lg:w-1/2 my-auto">{selectedData.articleLeft}</p>
//                 {selectedData.articleRightMediaType === "image" ? (
//                   <img
//                     src={selectedData.articleRightMediaUrl}
...
//                 )}
//               </div>
//               <h1 className="capitalize text-center font-bold text-xl order-2">
//                 {selectedData.articleH2}
//               </h1>
...
//                   src={selectedData.visualCenterMediaUrl}
//                   alt="visual-center"
//                   className="h-96 rounded-md order-3"
//                 />
//               ) : (
//                 <video
//                   src={selectedData.visualCenterMediaUrl}
...
//                 />
//               )}
//               <p className="order-4">{selectedData.articleCenter}</p>
//               <span className="text-sm order-5">{selectedData.articleSmall}</span>
//               <CodeBlock code={selectedData.articleCode} />
//             </div>
//           </div>
//         </div>
