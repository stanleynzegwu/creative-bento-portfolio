...
import FadingImageDisplacementExperience from "@/canvas/FadeInImageDisplacement";
...
//         <div className="relative flex gap-8">
//           <div className="relative hidden flex-1 md:flex gap-4">
//             <div className="relative rounded-lg z-10 h-96 xl:w-[60%]">
//               <FadingImageDisplacementExperience
//                 image1={"/images/dispImage3.jpg"}
//                 image2={"/images/dispImage4.jpg"}
//                 image3={"/images/dispImage4.jpg"}
//                 aspectObject={{ sm: 13 / 16, lg: 12 / 17 }}
//               />
//             </div>
//             <div className="hidden mt-10 h-60 xl:w-[40%] xl:inline-block">
//               <img
//                 src="/images/dispImage1.jpg"
//                 alt=""
//                 className=" rounded-lg h-60 w-full aspect-auto"
...
//             </div>
//             <div className="flex-1">
//               <div className="relative h-44 md:h-60 lg:h-60">
//                 {/* <img src="/images/womantree2.jpg" alt="" className=" w-full h-64 rounded-lg" /> */}
//                 <FadingImageDisplacementExperience
//                   image1={"/images/dispImage3.jpg"}
//                   image2={"/images/dispImage4.jpg"}
//                   image3={"/images/dispImage4.jpg"}
//                   aspectObject={{ sm: 13 / 16, lg: 11 / 6 }}
//                 />
//                 {/* Gradient overlay */}
//                 <div className="absolute inset-0 z-10 pointer-events-none bg-radial-gradient" />
//               </div>
